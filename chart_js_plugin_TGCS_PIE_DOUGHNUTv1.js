 ...
 * * -------------	-----------	-------------------------------------------------
 * * 11-19-2018		Shive		New for Pie or Doughnut w/o edited tooltips.
 * * ============================================================================
 */
  var chartMap = {};
  var chart_js_plugin_TGCS_PIE_DOUGHNUTv1 = function (settings) {
    var self = this;    
  ...
  freeboard.loadWidgetPlugin({
    "type_name": "chart_js_plugin_TGCS_PIE_DOUGHNUTv1",
    "display_name": "chart_js_plugin_TGCS_PIE_DOUGHNUTv1",    
    "fill_size": true,
    "external_scripts": [
    ...
    newInstance: function (settings, newInstanceCallback) {
      newInstanceCallback(new chart_js_plugin_TGCS_PIE_DOUGHNUTv1(settings));
    }
  });
