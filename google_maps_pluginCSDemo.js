(function () {
    var googleMapWidget = function (settings) {
        ...
        window.__gMapsOpenDashboard = function (storeNumber) {
            window.open(currentSettings.storeDashboard);
        }
                    ...
                    if (_store.alertState == true) {
						...
						if(_store.storeDashboardAvailable == true) {
							_store.contentString = '<div id="content">' +
								'<div id="siteNotice">' +
								'</div>' +
								'<h1 id="xfirstHeading">Store Alert</h1>' +
    ...
    freeboard.loadWidgetPlugin({
        type_name: "google_map_ext_CSDemo",
        display_name: "Google Map CSDemo",
        fill_size: true,
        settings: [{
                name: "apikey",
            ...
            {
                name: "storeDashboard",
                display_name: "Store Dashboard URL",
                type: "text"
            }
        ],
